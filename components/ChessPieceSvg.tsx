...
export const ChessPieceSvg: React.FC<ChessPieceSvgProps> = ({ type, color, className = "w-10 h-10" }) => {
  ...
  switch (pieceKey) {
    ...
    case "wP":
      return (
        <svg viewBox="0 0 45 45" className={className} xmlns="http://www.w3.org/2000/svg" version="1.1">
          <path
