        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-5 relative flex justify-center lg:justify-start">
              ...
              <div className="absolute top-4 left-4 w-full max-w-[340px] md:max-w-[400px] aspect-[3/4] bg-[#E11D48] rounded-[2.5rem] rounded-tr-[8rem] -z-10 shadow-2xl" />
              ...
              <div className="absolute -left-4 bottom-8 bg-slate-900 border border-slate-800 text-white rounded-2xl p-4 shadow-2xl flex items-center gap-3 select-none z-20">
                <div className="w-10 h-10 rounded-xl bg-[#0B4398]/10 text-[#0B4398] flex items-center justify-center shrink-0">
                  <ShieldCheck className="w-5 h-5" />
                </div>
                <div>
                  <p className="text-[9px] font-black uppercase text-slate-400 tracking-wider">FIDE Certified</p>
                  <p className="text-xs font-black text-white mt-0.5">FIDE ID: 35031686</p>
                </div>
              </div>
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              {/* Tag Label */}
              <div className="flex items-center gap-3 text-[10px] font-black uppercase tracking-widest text-[#0B4398]">
                <span className="w-8 h-[2px] bg-[#0B4398]" />
                <span>Founder & Head Coach</span>
              </div>

              {/* Title Name */}
              <h3 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight leading-none">
                G Karthik <span className="text-[#0B4398]">Gopal.</span>
              </h3>

              {/* Bio Description Paragraphs */}
              <div className="space-y-4 text-slate-600 text-sm md:text-base font-light leading-relaxed">
                <p>
                  As the Founder of <strong className="text-slate-950 font-bold">Modern Knight Chess Academy</strong>, G. Karthik Gopal is passionate about creating a structured and progressive learning environment for young chess players. With a strong understanding of the game and a practical approach to coaching, he helps students develop both confidence and competitive skills.
                </p>
                <p>
                  His training emphasizes clear thinking, accurate calculation, tactical awareness, and strategic decision-making. Through personalized guidance and consistent practice, he aims to help every student unlock their potential and develop a lasting passion for chess.
                </p>
              </div>
              ...
              <div className="pt-2">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  ...
                  <div className="flex items-center gap-2 px-3.5 py-2.5 bg-slate-50 border border-slate-100 rounded-xl">
                    ...
                    <span className="text-xs font-black text-slate-800">FIDE 1848</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2 px-3.5 py-2.5 bg-slate-50 border border-slate-100 rounded-xl">
                    ...
                    <span className="text-xs font-black text-slate-800">Nat. Arbiter</span>
                  </div>
