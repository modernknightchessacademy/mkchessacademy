          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="space-y-4 text-slate-600 text-sm md:text-base font-light leading-relaxed">
                <p>
                  As the Founder of <strong className="text-slate-900 font-bold">Modern Knight Chess Academy</strong>, G Hema Chandra Mouli is dedicated to raising the standard of chess coaching. He blends deep positional knowledge with modern software analysis to train the next generation of chess masters.
                </p>
                <p>
